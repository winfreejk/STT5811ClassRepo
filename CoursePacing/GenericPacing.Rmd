...
2.  All due dates are 5 PM Friday for PDS CrowdGrader assignments and 5 PM Tuesdays for ISCAMIII CrowdGrader assignments.

3.  All PDS CrowdGrader peer reviews must be completed by 11 PM on Tuesdays and all ISCAMIII peer reviews must be completed by 11 PM on Saturdays.

4.  Peer review feedback will close at 8 AM Wednesdays for PDS CrowdGrader assignments and 8 AM Mondays for ISCAMIII CrowdGrader assignments.

5. The class will update the grading rubrics for the PDS assignments two weeks prior to each due date (for STT 2810).

6. Mondays will be devoted to material in PDS, and Wednesdays and Fridays will be devoted to investigations from ISCAMIII.

7. Directions for all **ISCAM PR#** submissions:

  a. All submissions must be in R markdown.
...
8.  The grading rubric for all **ISCAM PR#** submissions can be found in the [grubric](https://github.com/STAT-ATA-ASU/STT5811ClassRepo/tree/master/grubric) directory.  
...
* Submit at least one suggestion for improving the week 3 (**Literature Review / Citation  Assignment (PR#1)**) grading rubric on [piazza](https://piazza.com/class/ida59td3ddq3zi) prior to class.

**Friday**

* Read and Complete *Investigation 1.1: Friend or Foe?* from ISCAMIII prior to class.

* Discuss and finalize the week 3 (**Literature Review / Citation  Assignment (PR#1)**) grading rubric.
...
* Submit ISCAM PR#1 (*Investigation B: Random Babies* parts i and o; *Investigation 1.1: Friend or Foe?* parts a, f, g, h, l, and m; RR chapters 1-2.)  The direct link for the assignment is [https://www.crowdgrader.org/crowdgrader/venues/view_venue/1274](https://www.crowdgrader.org/crowdgrader/venues/view_venue/1274).
