...
1.  Direct links for [CrowdGrader](http://www.crowdgrader.org/) assignments will be updated during the course and in piazza.
...
```
git remote add upstream https://github.com/STAT-ATA-ASU/STT2810ClassRepo.git
```
* Verify with
```
git remote -v
