...
* Review course materials (ISCAMIII, PDS, RR).  Write a detailed review and comment on which materials you found most helpful and which activities you found helpful (be very specific and site examples).  The report should be written with either `RMarkdown` (`.Rmd`) or `LaTeX` (`.Rnw`) and stored in your private repo in a directory named `MyFinal`.   Which materials and activities were not helpful (be very specific and site examples)?  List three areas where your knowledge increased during the semester (be very specific and cite examples).  Suggest potential reorderings of the course topics and rationale for doing so.  
